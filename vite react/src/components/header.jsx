...
const Header =()=>{
    useEffect(()=>{
        ...
        gsap.fromTo('.socials', { x: '100px', opacity: 0 }, { x: 0, opacity: 1, duration: 1, stagger:.5, delay: 2.5, ease:'bounce' })
    },[])
    return(
        <div id='home' className="header w-[100%] h-screen">
            ...
            <p className="text-white text-[20px] font-semibold mb-[50px] w-[80%] mx-auto ">
           ...
           <Link to='about' smooth={true}> <button className="border-[2px] px-[20px] py-[6px] border-[#DAA520] text-[#DAA520] hover:text-black hover:bg-[#DAA520] transition-all duration-300 text-[20px]">Learn more</button></Link>
            ...
            <div className="absolute right-[10px] top-[70%] sm:top-[50%] sm:translate-y-[-50%] socials">
                <div className="w-[2px] h-[100%] bg-[#754922]/70 absolute left-[15px] socials"></div>
                <ul>
